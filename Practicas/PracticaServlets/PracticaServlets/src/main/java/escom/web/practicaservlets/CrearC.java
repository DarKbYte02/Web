...
@WebServlet(name = "CrearC", urlPatterns = {"/CrearC"})
public class CrearC extends HttpServlet {
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<h5 class='card-header'>Creación exitosa</h5>");
            out.println("<div class='card-body'>");
            out.println("<p class='card-text text-start'>La creación de la nueva categoría se realizó con éxito.</p>");
