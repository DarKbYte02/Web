...
public class EliminarProducto extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            c.setIdProducto(Integer.parseInt(request.getParameter("id")));
            
            try {
                dao.eliminarProducto(c);
            ...
            out.println("<h5 class='card-header'>Eliminación realizada con éxito</h5>");
            out.println("<div class='card-body'>");
            out.println("<p class='card-text text-start'>La eliminación del producto se realizó con éxito.</p>");
            out.println("<div class='d-grid gap-2'>");
            out.println("<a class='btn btn-outline-warning' onclick='history.back()'>Regresar</a>");
            out.println("</div>");
            out.println("</div>");
            out.println("</div>");
            out.println("</div>");
