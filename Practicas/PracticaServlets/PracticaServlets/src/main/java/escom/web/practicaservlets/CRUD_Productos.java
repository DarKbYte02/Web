 ...
 */
@WebServlet(name = "CRUD_Productos", urlPatterns = {"/CRUD_Productos"})
public class CRUD_Productos extends HttpServlet {
...
"}</script>");
            ...
            out.println("<h2 class='card-title text-bg-dark'> Listado de Productos general</h2>");
            out.println("</div>");
